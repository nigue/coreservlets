...
public class EBill implements Comparable<EBill> {
	...
	protected void setEbiller(EBiller ebiller) {
		...
		// Need this to set composite key
	...
	protected void setAccount(Account account) {
		...
		// Need this to set composite key
		ebillId.setAccountId(account.getAccountId());
	 ...
	 *            the ebillId to set
	 */
	protected void setEbillId(EBillId ebillId) {
	...
	public int compareTo(EBill ebillToCompare) {
		return (this.ebillId.getDueDate().compareTo(ebillToCompare.getEbillId()
				.getDueDate()));
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((ebillId == null) ? 0 : ebillId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (datePaid == null) {
			...
			return false;
		if (ebillId == null) {
			if (other.ebillId != null)
				return false;
		} else if (!ebillId.equals(other.ebillId))
			return false;
