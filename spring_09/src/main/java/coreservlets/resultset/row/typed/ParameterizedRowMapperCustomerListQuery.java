...
public class ParameterizedRowMapperCustomerListQuery implements CustomerListQuery {
    ...
    public List<Customer> getCustomers() {
        return this.simpleJdbc.<Customer>query("select id, name from customer", customerRowMapper);
    }
