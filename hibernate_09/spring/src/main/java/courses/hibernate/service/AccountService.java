...
public class AccountService {
	...
	/**
	 * Set accountDAO
	 * @param accountDAO accountDAO to set. Used by Spring.
	 */
	...
	public int addInterestToSavingsAccounts() {
		return accountDAO.addInterestToSavingsAccounts();
	}
	...
	public int archiveAccounts() {
		return accountDAO.archiveAccounts();
	}
	...
	public int deleteArchivedAccounts() {
		return accountDAO.deleteArchivedAccounts();
	}
