...
public class FormUtils {
     ...
     */
    /**
     * Returns the word "copy" in singular or plural. That is, if n is 1,
     * returns "copy" (for use in phrase "1 copy"), otherwise returns "copies"
     * (for use in phrases like "2 copies").
     * @param n
     * @return 
     */
