...
public class AccountOwnerService {
	...
	/**
	 * Persist the accountOwner
	 * 
	 * @param accountOwner
	 *            accountOwner to be persisted
	 */
	public void persistAccountOwner(AccountOwner accountOwner) {
		accountOwnerDAO.persistAccountOwner(accountOwner);
	}
}
