package com.coreservlets.sayhellojava;
 ...
 * defined in the Java code. A later example does a similar task with layout and
 * strings defined in XML (res/layout/main.xml).
 * <p>
...
public class SayHelloJava extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String buttonLabel = "Show Greeting " + count;
    ...
    private class Toaster implements OnClickListener {
        ...
        public void onClick(View clickedButton) {
            count ++;
            String greetingText = "Hello from Android! " + count;
            Toast tempMessage
